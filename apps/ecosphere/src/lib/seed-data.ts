export const seedData = {
  ...
  esg_notifications: [
    { id: '1', type: 'compliance', message: 'Overdue compliance issue: Tier 2 supplier working hour violations', read: false, createdAt: '2023-10-02T08:00:00Z' },
    { id: '2', type: 'approval', message: '3 new challenge proofs waiting for your approval', read: true, createdAt: '2023-10-15T14:30:00Z' },
    { id: '3', type: 'system', message: 'Q3 Emissions data auto-calculated successfully', read: false, createdAt: '2023-10-01T00:05:00Z' }
  ],
  esg_config: {
